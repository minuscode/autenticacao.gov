 ...
 */
int Catalog::setSignatureByteRange(unsigned long sig_contents_offset, unsigned long estimated_len, unsigned long filesize, Object *signature_dict, Ref *signature_dict_ref)
{
                                     ...
                                     unsigned char *img_data, unsigned long img_length, int rotate_signature, bool isPTLanguage)
{
  ...
  if (!small_signature_format && reason != NULL && strlen(reason) > 0)
  {
    ...
    GooString *multiline = formatMultilineString(reason_latin1, rect_width, font_size, MYRIAD_ITALIC, 15, line_height);
                                         ...
                                         unsigned char *img_data, unsigned long img_length, int rotate_signature, bool isPTLanguage)
{
  ...
  GooString *name_str = formatMultilineString(name_latin1,
                                              rect_width, font_size, MYRIAD_BOLD, 15, line_height, rect_width - assinado_por_length);
  n2_commands->append(name_str);
  ...
  if (signer_info->attribute_provider != NULL)
  {
    ...
    GooString *name_str = formatMultilineString(name_latin1,
                                                rect_width, font_size_medium, MYRIAD_BOLD, 15,
  ...
  if (signer_info->attribute_name != NULL)
  {
    ...
    int heightLeft = (2 - linesName) * font_size + (2 - linesAttributeProvider) * font_size_medium + (2 - linesReason) * font_size + (1 - linesLocation) * font_size_medium;
